...
//#include "randomized-rounding/randomized-rounding-strategy.hpp"
...
main(int argc, char* argv[])
{
  ...
  // node UCLA-HUB
//  StrategyChoiceHelper::Install<nfd::fw::RandomizedRoundingStrategy>(Names::Find<Node>("UCLA-HUB"),
//                                                                     prefix);

  StrategyChoiceHelper::Install(Names::Find<Node>("UCLA-HUB"),prefix,
		  "ndn:/localhost/nfd/strategy/randomized-rounding");
  StrategyChoiceHelper::InstallAll(prefix,"ndn:/localhost/nfd/strategy/randomized-rounding");
